/**
 * basic-login.js — Basic login example for Kronos Workforce Central / UKG Pro
...
async function main() {
  ...
  try {
    log('Starting Kronos Workforce Central / UKG Pro automation (Open Source mode)');
    ...
    const result = await login_kronos(page, {
    ...
    // const data = await approve_timesheets(page, {});
    // log('Data:', data);
