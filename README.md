...
This project gives you a **complete browser automation scaffold** for Kronos Workforce Central / UKG Pro using Puppeteer (self-hosted, open source) or [AnchorBrowser](https://anchorbrowser.io) (cloud, managed, production-ready).
...
*Built with ❤️ for developers who need to automate Kronos Workforce Central / UKG Pro without wrestling with its API limitations. Powered by [AnchorBrowser](https://anchorbrowser.io) for cloud-scale automation.*
