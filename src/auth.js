/**
 * auth.js — Authentication handler for Kronos Workforce Central / UKG Pro
 * Supports: SSO (LDAP / SAML / AD), MFA (Duo / TOTP)
 *
...
const BASE_URL = process.env.KRONOS_UKG_URL || 'https://your-company.kronos.net/wfc/navigator/logon';
const USERNAME = process.env.KRONOS_UKG_USERNAME;
const PASSWORD = process.env.KRONOS_UKG_PASSWORD;
...
async function performLogin(page) {
  if (!USERNAME || !PASSWORD) {
    throw new Error(`Set KRONOS_UKG_USERNAME and KRONOS_UKG_PASSWORD in .env`);
  }

  console.log('Logging in to Kronos Workforce Central / UKG Pro...');
  await page.goto(BASE_URL, { waitUntil: 'networkidle2' });
